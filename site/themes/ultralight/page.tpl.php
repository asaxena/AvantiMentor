		...
		<div id="place">
			<div id="wraper" class="wraper">&nbsp;
					...
					<div id="container" class="container">
							...
							<?php if ($logo): ?>
              <div id="logo"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" id="logo-image" /></a>
			  <br /><span style="color: black;display: inline-block;font-size: 15px;font-weight: bold; margin-top: 10px;">Mentorship Platform</span>
			  </div><?php endif; ?>
